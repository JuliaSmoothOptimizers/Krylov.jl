function test_alloc()
  ...
  (x, stats) = crls(Lo, b)  # warmup
  actual_crls_bytes = @allocated crls(Lo, b)
  @test actual_crls_bytes ≤ 1.02 * expected_crls_bytes

  solver = CrlsSolver(Lo, b)
  crls!(solver, Lo, b)  # warmup
  inplace_crls_bytes = @allocated crls!(solver, Lo, b)
