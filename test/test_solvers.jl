function test_solvers(FC; variant::Bool=false)
  ...
  if variant
    ...
    @eval begin
      ...
      $solvers[:diom] = $(KRYLOV_SOLVERS[:diom])($kc_nn; memory=$mem)
      $solvers[:fom] = $(KRYLOV_SOLVERS[:fom])($kc_nn; memory=$mem)
      $solvers[:dqgmres] = $(KRYLOV_SOLVERS[:dqgmres])($kc_nn; memory=$mem)
      $solvers[:gmres] = $(KRYLOV_SOLVERS[:gmres])($kc_nn; memory=$mem)
      $solvers[:gpmr] = $(KRYLOV_SOLVERS[:gpmr])($kc_nm; memory=$mem)
      $solvers[:fgmres] = $(KRYLOV_SOLVERS[:fgmres])($kc_nn; memory=$mem)
    ...
    @eval begin
      ...
      $solvers[:diom] = $(KRYLOV_SOLVERS[:diom])($n, $n, $S; memory=$mem)
      $solvers[:fom] = $(KRYLOV_SOLVERS[:fom])($n, $n, $S; memory=$mem)
      $solvers[:dqgmres] = $(KRYLOV_SOLVERS[:dqgmres])($n, $n, $S; memory=$mem)
      $solvers[:gmres] = $(KRYLOV_SOLVERS[:gmres])($n, $n, $S; memory=$mem)
      $solvers[:gpmr] = $(KRYLOV_SOLVERS[:gpmr])($n, $m, $S; memory=$mem)
      $solvers[:fgmres] = $(KRYLOV_SOLVERS[:fgmres])($n, $n, $S; memory=$mem)
