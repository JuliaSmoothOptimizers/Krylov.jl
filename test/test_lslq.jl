@testset "lslq" begin
  ...
  A = U * [Σ ; zeros(2, 4)] * V'
  b = ones(6)
  (x, stats) = lslq(A, b, σ=1 - 1.0e-10, history=true)
  ...
  M⁻¹ = inv(M)
  N⁻¹ = inv(N)
  (x_lq, stats) = lslq(A, b, M=M⁻¹, N=N⁻¹, sqd=true)
  r = M⁻¹ * (b - A * x_lq)
