...
cg_lanczos_shift_par(A :: AbstractMatrix{TA}, b :: AbstractVector{Tb}, shifts :: AbstractVector{Ts};
                     atol :: Float64=1.0e-8, rtol :: Float64=1.0e-6, itmax :: Int=0,
                     check_curvature :: Bool=false, verbose :: Bool=false) where {TA, Tb, Ts <: Number} =
