...
for (workspace, krylov, is_extended_workspace, args, def_args, optargs, def_optargs, kwargs, def_kwargs, kwargs_workspace, def_kwargs_workspace) in [
  (:LsmrWorkspace     , :lsmr      , true , args_lsmr      , def_args_lsmr      , ()                , ()                    , kwargs_lsmr      , def_kwargs_lsmr      , kwargs_workspace_lsmr   , def_kwargs_workspace_lsmr   )
  ...
  (:LsqrWorkspace     , :lsqr      , true , args_lsqr      , def_args_lsqr      , ()                , ()                    , kwargs_lsqr      , def_kwargs_lsqr      , kwargs_workspace_lsqr   , def_kwargs_workspace_lsqr   )
  (:MinresWorkspace   , :minres    , false, args_minres    , def_args_minres    , optargs_minres    , def_optargs_minres    , kwargs_minres    , def_kwargs_minres    , kwargs_workspace_minres , def_kwargs_workspace_minres )
  ...
  (:DqgmresWorkspace  , :dqgmres   , false, args_dqgmres   , def_args_dqgmres   , optargs_dqgmres   , def_optargs_dqgmres   , kwargs_dqgmres   , def_kwargs_dqgmres   , kwargs_workspace_dqgmres, def_kwargs_workspace_dqgmres)
  (:SymmlqWorkspace   , :symmlq    , false, args_symmlq    , def_args_symmlq    , optargs_symmlq    , def_optargs_symmlq    , kwargs_symmlq    , def_kwargs_symmlq    , kwargs_workspace_symmlq , def_kwargs_workspace_symmlq )
  ...
  (:DiomWorkspace     , :diom      , false, args_diom      , def_args_diom      , optargs_diom      , def_optargs_diom      , kwargs_diom      , def_kwargs_diom      , kwargs_workspace_diom   , def_kwargs_workspace_diom   )
  (:LslqWorkspace     , :lslq      , true , args_lslq      , def_args_lslq      , ()                , ()                    , kwargs_lslq      , def_kwargs_lslq      , kwargs_workspace_lslq   , def_kwargs_workspace_lslq   )
  ...
  (:SqmrWorkspace     , :sqmr      , false, args_sqmr      , def_args_sqmr      , optargs_sqmr      , def_optargs_sqmr      , kwargs_sqmr      , def_kwargs_sqmr      , ()                      , ()                          )
  (:GmresWorkspace    , :gmres     , false, args_gmres     , def_args_gmres     , optargs_gmres     , def_optargs_gmres     , kwargs_gmres     , def_kwargs_gmres     , kwargs_workspace_gmres  , def_kwargs_workspace_gmres  )
  ...
  if krylov in (:cg_lanczos_shift, :cgls_lanczos_shift)
    ...
    if isempty(kwargs_workspace)
      ...
      @eval krylov_workspace(::Val{Symbol($krylov)}, kc::KrylovConstructor; $(def_kwargs_workspace...)) = $workspace(kc; $(kwargs_workspace...))
      @eval krylov_workspace(::Val{Symbol($krylov)}, m::Integer, n::Integer, S::Type; $(def_kwargs_workspace...)) = $workspace(m, n, S; $(kwargs_workspace...))
      @eval krylov_workspace(::Val{Symbol($krylov)}, A, b; $(def_kwargs_workspace...)) = $workspace(A, b; $(kwargs_workspace...))
      if is_extended_workspace
        @eval krylov_workspace(::Val{Symbol($krylov)}, m::Integer, n::Integer, Sm::Type, Sn::Type; $(def_kwargs_workspace...)) = $workspace(m, n, Sm, Sn; $(kwargs_workspace...))
      end
      if krylov == :gpmr
        @eval krylov_workspace(::Val{Symbol($krylov)}, A, b, c; $(def_kwargs_workspace...)) = $workspace(A, b, c; $(kwargs_workspace...))
        @eval krylov_workspace(::Val{Symbol($krylov)}, A, B, b, c; $(def_kwargs_workspace...)) = $workspace(A, B, b, c; $(kwargs_workspace...))
      end
    end
  end
  ...
  ## In-place
  if is_extended_workspace  # workspace --> KrylovWorkspace{T,FC,Sm,Sn}
  ...
  else  # workspace --> KrylovWorkspace{T,FC,S,S}
...
for (workspace, krylov, args, def_args, optargs, def_optargs, kwargs, def_kwargs, kwargs_workspace, def_kwargs_workspace) in [
  ...
  if isempty(kwargs_workspace)
      ...
      @eval krylov_workspace(::Val{Symbol($krylov)}, m::Integer, n::Integer, p::Integer, SV::Type, SM::Type; $(def_kwargs_workspace...)) = $workspace(m, n, p, SV, SM; $(kwargs_workspace...))
      @eval krylov_workspace(::Val{Symbol($krylov)}, A, B; $(def_kwargs_workspace...)) = $workspace(A, B; $(kwargs_workspace...))
  end
