...
cg_lanczos{TA <: Number, Tb <: Number}(A :: Array{TA,2}, b :: Array{Tb,1};
  ...
  cg_lanczos(LinearOperator(A), b, atol=atol, rtol=rtol, itmax=itmax, verbose=verbose);
...
cg_lanczos_shift_seq{TA <: Number, Tb <: Number, Ts <: Number}(A :: Array{TA,2}, b :: Array{Tb,1}, shifts :: Array{Ts,1};
                                                               atol :: Float64=1.0e-8, rtol :: Float64=1.0e-6, itmax :: Int=0, verbose :: Bool=false) =
  cg_lanczos_shift_seq(LinearOperator(A), b, shifts, atol=atol, rtol=rtol, itmax=itmax, verbose=verbose);
...
cg_lanczos_shift_par{TA <: Number, Tb <: Number, Ts <: Number}(A :: Array{TA,2}, b :: Array{Tb,1}, shifts :: Array{Ts,1};
                                                               atol :: Float64=1.0e-8, rtol :: Float64=1.0e-6, itmax :: Int=0, verbose :: Bool=false) =
  cg_lanczos_shift_par(LinearOperator(A), b, shifts, atol=atol, rtol=rtol, itmax=itmax, verbose=verbose);
